console.log('Made with ❤️ by Vitamin')
...
function draw() {
  ...
  text(textInstructions, windowWidth / 2, windowHeight / 2 - 60);
  textStyle(NORMAL);
  textSize(16);
  text('PRESS THE KEYS:', windowWidth / 2, windowHeight / 2 - 24);
  textAlign(LEFT, CENTER);
  text('1 - NEGATIVE MAGNETISM', windowWidth / 2 - textInstructions.length*32/4 - 16, windowHeight / 2 + 4);
  text('2 - POSITIVE MAGNETISM', windowWidth / 2- textInstructions.length*32/4- 16, windowHeight / 2 + 18);
  text('3 - STRONG NUCLEAR', windowWidth / 2- textInstructions.length*32/4- 16, windowHeight / 2 + 32);
  text('4 - WEAK NUCLEAR', windowWidth / 2- textInstructions.length*32/4- 16, windowHeight / 2 + 46);
  text('5 - GRAVITY', windowWidth / 2- textInstructions.length*32/4- 16, windowHeight / 2 + 60);
  text('I - FOR INSTRUCTIONS', windowWidth / 2- textInstructions.length*32/4- 16, windowHeight /2 + 76)
  textAlign(CENTER, CENTER);
  
  text('PRESS I OR CLICK TO EXIT', windowWidth / 2, windowHeight - 100)
